...
public class EventRecord extends UpdatableRecordImpl<EventRecord> implements Record8<Long, String, String, Timestamp, String, String, EventStatus, Integer>, IEvent {

    private static final long serialVersionUID = -1277592952;
     ...
     */
    @Override
    public Row8<Long, String, String, Timestamp, String, String, EventStatus, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row8<Long, String, String, Timestamp, String, String, EventStatus, Integer> valuesRow() {
     ...
     */
    @Override
    public EventRecord values(Long value1, String value2, String value3, Timestamp value4, String value5, String value6, EventStatus value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EventRecord(Long id, String name, String contact, Timestamp date, String details, String location, EventStatus status, Integer maxParticipants) {
        super(Event.EVENT);
