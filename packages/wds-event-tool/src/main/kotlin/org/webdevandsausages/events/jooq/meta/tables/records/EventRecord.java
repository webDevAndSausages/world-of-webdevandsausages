...
public class EventRecord extends UpdatableRecordImpl<EventRecord> implements Record14<Long, String, String, String, Timestamp, String, String, EventStatus, Integer, Timestamp, Timestamp, Timestamp, Integer, String>, IEvent {

    private static final long serialVersionUID = 759390659;
    ...
    public void from(IEvent from) {
        ...
        setSponsorLink(from.getSponsorLink());
    }
