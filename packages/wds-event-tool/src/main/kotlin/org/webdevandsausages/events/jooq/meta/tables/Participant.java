...
public class Participant extends TableImpl<ParticipantRecord> {
    ...
    private static final long serialVersionUID = -1370266918;
     ...
     */
    public final TableField<ParticipantRecord, String> FIRST_NAME = createField("first_name", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>public.participant.last_name</code>.
     */
    public final TableField<ParticipantRecord, String> LAST_NAME = createField("last_name", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
     ...
     */
    public final TableField<ParticipantRecord, String> AFFILIATION = createField("affiliation", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
     ...
     */
    public final TableField<ParticipantRecord, Integer> ORDER_NUMBER = createField("order_number", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
