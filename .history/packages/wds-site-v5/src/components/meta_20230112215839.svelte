<script>
  ...
  export let description = "A meetup based in Tampere, Finland for those interested in web-based technologies and programming in various languages, or just hungry for sausages."
</script>
